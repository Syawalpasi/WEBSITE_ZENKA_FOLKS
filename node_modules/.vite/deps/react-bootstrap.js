...
import {
  ...
  usePopper_default,
  useUncontrolledProp
} from "./chunk-6RXSUXIV.js";
import {
  contains
} from "./chunk-GCD5O5GK.js";
import {
...
var CardGroup = React9.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React10.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselItem = React11.forwardRef(({
  ...
  const finalClassName = (0, import_classnames11.default)(className, useBootstrapPrefix(bsPrefix, "carousel-item"));
...
function map(children, func) {
  let index = 0;
  return React12.Children.map(children, (child) => React12.isValidElement(child) ? func(child, index++) : child);
}
...
function hasChildOfType(children, type) {
  return React12.Children.toArray(children).some((child) => React12.isValidElement(child) && child.type === type);
}
...
var Carousel = React13.forwardRef(({
  ...
  const {
    ...
    onTouchMove,
    onTouchEnd,
    prevIcon = (0, import_jsx_runtime13.jsx)("span", {
      "aria-hidden": "true",
      className: "carousel-control-prev-icon"
    }),
    prevLabel = "Previous",
    nextIcon = (0, import_jsx_runtime13.jsx)("span", {
      "aria-hidden": "true",
  ...
  return (0, import_jsx_runtime14.jsxs)(Component2, {
    ref: elementRef,
    ...props,
    ...
    className: (0, import_classnames12.default)(className, prefix, slide && "slide", fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
    children: [indicators && (0, import_jsx_runtime13.jsx)("div", {
      className: `${prefix}-indicators`,
      children: map(children, (_, index) => (0, import_jsx_runtime13.jsx)("button", {
        type: "button",
        "data-bs-target": "",
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime13.jsx)(TransitionWrapper_default, {
          in: isActive,
          onEnter: isActive ? handleEnter : void 0,
          onEntered: isActive ? handleEntered : void 0,
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React13.cloneElement(child, {
            ...innerProps,
            className: (0, import_classnames12.default)(child.props.className, isActive && status !== "entered" && orderClassName, (status === "entered" || status === "exiting") && "active", (status === "entering" || status === "exiting") && directionalClassName)
          })
        }) : React13.cloneElement(child, {
          className: (0, import_classnames12.default)(child.props.className, isActive && "active")
        });
      })
    }), controls && (0, import_jsx_runtime14.jsxs)(import_jsx_runtime15.Fragment, {
      children: [(wrap || activeIndex !== 0) && (0, import_jsx_runtime14.jsxs)(Anchor_default, {
        className: `${prefix}-control-prev`,
        onClick: prev,
        children: [prevIcon, prevLabel && (0, import_jsx_runtime13.jsx)("span", {
          className: "visually-hidden",
          children: prevLabel
        })]
      }), (wrap || activeIndex !== numChildren - 1) && (0, import_jsx_runtime14.jsxs)(Anchor_default, {
        className: `${prefix}-control-next`,
        onClick: next,
        children: [nextIcon, nextLabel && (0, import_jsx_runtime13.jsx)("span", {
          className: "visually-hidden",
          children: nextLabel
        })]
      })]
...
var DropdownButton = React14.forwardRef(({
  title,
  children,
  bsPrefix,
  rootCloseEvent,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime17.jsxs)(Dropdown_default, {
  ref,
  ...props,
  children: [(0, import_jsx_runtime16.jsx)(DropdownToggle_default, {
    id,
    href,
    size: size2,
    variant,
    ...
    children: title
  }), (0, import_jsx_runtime16.jsx)(DropdownMenu_default, {
    role: menuRole,
...
var Image = React15.forwardRef(({
  ...
  return (0, import_jsx_runtime18.jsx)("img", {
    // eslint-disable-line jsx-a11y/alt-text
    ref,
    ...props,
    className: (0, import_classnames13.default)(className, fluid && `${bsPrefix}-fluid`, rounded && `rounded`, roundedCircle && `rounded-circle`, thumbnail && `${bsPrefix}-thumbnail`)
  });
});
...
var FigureImage = React16.forwardRef(({
  className,
  fluid = true,
  ...props
  ...
  ...props,
  fluid,
  className: (0, import_classnames14.default)(className, "figure-img")
}));
...
var FigureCaption = React17.forwardRef(({
  className,
  bsPrefix,
...
var Feedback = React19.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormCheckInput = React21.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React22.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React23.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0, import_react6.useMemo)(() => ({
...
var FormFloating = React25.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var FormGroup = React26.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormRange = React28.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React29.forwardRef(({
  bsPrefix,
  size: size2,
  htmlSize,
  className,
...
var FormText = React30.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React31.forwardRef((props, ref) => (0, import_jsx_runtime35.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React32.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroupText = React34.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var InputGroup = React35.forwardRef(({
  bsPrefix,
  size: size2,
  hasValidation,
  className,
...
var ListGroupItem = React36.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React37.forwardRef((props, ref) => {
  const {
    className,
...
var ModalBody = React38.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalDialog = React39.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
  ...
  return (0, import_jsx_runtime44.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames34.default)(dialogClass, className, size2 && `${bsPrefix}-${size2}`, centered && `${dialogClass}-centered`, scrollable && `${dialogClass}-scrollable`, fullscreen && fullScreenClass),
    children: (0, import_jsx_runtime44.jsx)("div", {
      className: (0, import_classnames34.default)(`${bsPrefix}-content`, contentClassName),
      children
    })
  });
});
...
var ModalFooter = React40.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalHeader = React41.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React42.forwardRef(({
  className,
  bsPrefix,
...
var Modal = React43.forwardRef(({
  ...
  const renderBackdrop = (0, import_react13.useCallback)((backdropProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames38.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && "show")
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime48.jsx)("div", {
    ...
    className: (0, import_classnames38.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React44.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
  ...
  const [exited, setExited] = (0, import_react15.useState)(!props.show);
...
var PopoverHeader = React45.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React46.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React48.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsxs)("div", {
    ...
    className: (0, import_classnames41.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Tooltip = React49.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime54.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames42.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
...
function useOverlayOffset(customOffset) {
  ...
  const offset = (0, import_react16.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React50.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react17.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react17.useState)(null);
  ...
  return (0, import_jsx_runtime55.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React50.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames43.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react18.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react18.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React51.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  const handleHide = (0, import_react18.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react18.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react18.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react18.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react18.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react18.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime58.jsxs)(import_jsx_runtime57.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react18.cloneElement)(children, triggerProps), (0, import_jsx_runtime56.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React52.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime59.jsx)("li", {
    ...
    children: (0, import_jsx_runtime60.jsxs)(Component2, {
...
function createButton(name, defaultValue, label = name) {
  const Button = React52.forwardRef(({
    children,
    ...props
...
var Pagination = React53.forwardRef(({
  ...
  return (0, import_jsx_runtime61.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames45.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
var PlaceholderButton = React54.forwardRef((props, ref) => {
...
var Placeholder = React55.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime64.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames47.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime64.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React56.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime64.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react19.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min,
      now,
...
var Ratio = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime65.jsx)("div", {
    ...
    className: (0, import_classnames48.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
...
var Spinner = React58.forwardRef(({
  ...
  return (0, import_jsx_runtime66.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames49.default)(className, bsSpinnerPrefix, size2 && `${bsSpinnerPrefix}-${size2}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react20.useContext)(TabContext_default);
  if (!context)
...
var TabPanel = React61.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react21.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react21.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContent = React64.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React65.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
    ...
    children: (0, import_jsx_runtime74.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime74.jsx)(Transition, {
        ...
        children: (0, import_jsx_runtime74.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames52.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Table = React66.forwardRef(({
  ...
  const classes = (0, import_classnames53.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size2 && `${decoratedBsPrefix}-${size2}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime75.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime76.jsx)(NavItem_default, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime76.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime77.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime76.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime76.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime76.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React68.forwardRef((props, ref) => (0, import_jsx_runtime78.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React69.createContext({
...
var ToastHeader = React70.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context = (0, import_react22.useContext)(ToastContext_default);
  ...
  return (0, import_jsx_runtime80.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames54.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime79.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var ToastBody = React71.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Toast = React72.forwardRef(({
  ...
  const delayRef = (0, import_react23.useRef)(delay);
  ...
  const autohideFunc = (0, import_react23.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react23.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition && animation);
  const toast = (0, import_jsx_runtime82.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames56.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime82.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime82.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToastContainer = React73.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime83.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames57.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop2 = () => void 0;
var ToggleButton = React74.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime86.jsxs)(import_jsx_runtime85.Fragment, {
    children: [(0, import_jsx_runtime84.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime84.jsx)(Button_default, {
      ...props,
      ref,
      className: (0, import_classnames58.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React75.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime87.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
